...
//
// Class declaration for CSerialPort.  This class is a wrapper for the
// Win32 serial communication API functions.
//
...
//  Neither defined            - Assumed to be #include for app DLL import
//
// ========================================================================
...
#define ASCII_ENQ       0x0D
#define ASCII_ACK       0x0E
#define ASCII_XON       0x11
#define ASCII_XOFF      0x13
#define ASCII_NAK       0x15
#define ASCII_CAN       0x18
#define ASCII_SEPARATOR 0x09
...
// ========================================================================
class /*COMMDLL_DLLCLASS*/ CSerialPort
{
protected:
...
//    BOOL SetBaudRate(int nBaudRate = CBR_19200);
    BOOL SetBaudRate(long lBaudRate = CBR_19200);
    ...
    BOOL SetReadTimeouts(int nInterval = MAXDWORD, int nMultiplier = 0,
                         int nConstant = 0);
    ...
    virtual int WriteCommBlock(LPCSTR lpBytes, int nBytesToWrite);
